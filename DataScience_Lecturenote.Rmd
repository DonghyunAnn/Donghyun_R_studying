...
getwd()
setwd("C:/Users/user/Documents/github_Rstudio_workspace/Data")
bmi<- read.csv("bmi_clean.csv",header = TRUE)
str(bmi)
dim(bmi)
names(bmi)
class(bmi)
...
######################data cleaning########################
library("tidyr")
#gather(df, columnname,columnname 범위) # 넓은 데이터를 좁게
...
#exercise3
students2 <- read.csv('students2.csv',header=TRUE,stringsAsFactors = F)
str(students2)
library('lubridate')

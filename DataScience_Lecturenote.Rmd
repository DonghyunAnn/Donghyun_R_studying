...
#read.csv
getwd()
setwd("C/Users/user/Documents/github_Rstudio_workspace")
...
#sort(백터, decreasing=T)     order(백터) 결과는 정렬되는 인덱스 백터가 나옴 sort는 order을 내포하고 있음
...
#cut-> 명목형 변수로 나타낼 때
mtcars$wt
cut(mtcars$wt,breaks = c(0,2,4,6), label=c(1,2,3), right)
...
#paste 1. 문자끼리 붙이디 2. 벡터 인덱스 같은것끼리 붙이기 3. 
x <- seq(2,20.2)
y <- LETTERS[1:10]
paste(x,y,sep = ';')
